        ...
        <header className="navbar-sticky">
            ...
            <nav className="navbar navbar-expand-lg navbar-light "
                ...
                <div className="container-fluid ">
                    ...
                    <div className="nav-log-cart mt-2 flex-wrap">
                        {
                            userInfo
                                ?
                                    ...
                                    userInfo && userInfo.user.Admin === true
                                        ? <div className="dropdown me-1 mt-0 d-flex flex-column">
                                            ...
                                            <ul className="dropdown-menu">
                                                <li><NavLink className="dropdown-item" to={`/profile/${userInfo.user.id}`}>Profile</NavLink></li>
                    ...
                    <div className="m-auto">
                        ...
                        <ul className="nav">
                            ...
                            <li className="dropdown">
                                ...
                                <ul className="dropdown-menu">
                                    <li>
                                        <NavLink className="dropdown-items nav-link1" to="/Womans/woman">All</NavLink>
                                    </li>
                                    <li>
                            ...
                            <li className="nav-item">
                                <NavLink className="nav-link1" to="/contact">Contact</NavLink>
                            </li>
                            <li className="nav-item">
                                <NavLink className="nav-link1" to="/about">About</NavLink>
                            </li>
                        </ul>
