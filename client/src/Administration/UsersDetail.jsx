                                        ...
                                        .map((user) => {
                                            return (
                                                <tr key={user._id}>
                                                    ...
                                                    <td>
                                                        {user.isAdmin === true ?
                                                            <button className='btn btn-secondary btn-sm' onClick={() => setEDTUser(true)} >
                                                                Edit
                                                            </button> : <button className='btn btn-secondary btn-sm' onClick={() => deleteUser(user._id)} >
                                                                Delete
                                                            </button>
                                                        ...
                                                        {
                                                            edtUser ?
                                                                (<button className='btn btn-secondary btn-sm' onClick={() => setEDTUser(false)} >
                                                                    Cancel
                                                                </button>) : ""
